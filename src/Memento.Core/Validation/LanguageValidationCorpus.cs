...
public static class LanguageValidationCorpus
{
    ...
    [
        ...
        new("mix-zh-001", LanguageValidationCategory.CantoneseMandarin, "我聽日要返工，但是有啲攰", [], true, false, ["聽日要返工", "但是有啲攰"]),
        new("mix-en-001", LanguageValidationCategory.CantoneseEnglish, "我唔記得個 product name", ["product name"], true, true, ["product name"]),
