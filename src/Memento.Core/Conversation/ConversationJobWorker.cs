...
public sealed class ConversationJobWorker
{
    ...
    public async Task RunUntilCancelledAsync(TimeSpan interval, CancellationToken cancellationToken = default, IProgress<ConversationWorkerRunResult>? progress = null)
    {
