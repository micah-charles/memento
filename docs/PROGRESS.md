...
- The MSIX staging path now copies checked-in deterministic MEMENTO artwork from `packaging/assets` instead of generating 1x1 placeholders. The rebuilt unsigned package is **108,731,412 bytes**, SHA-256 `0a8a2e48e5bc2c8967c68e54e35dca9f600274930afe107901192aaebe508b87`; the artwork dimensions are `StoreLogo` 256x256, `Square150x150Logo` 150x150, `Square44x44Logo` 44x44, and `SplashScreen` 620x300. The package verifier passed; publisher certificate trust and target deployment remain open.
