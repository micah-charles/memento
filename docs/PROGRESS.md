...
- The MSIX staging path now copies checked-in deterministic MEMENTO artwork from `packaging/assets` instead of generating 1x1 placeholders. The rebuilt unsigned package is **108,730,093 bytes**, SHA-256 `9c9a2ad1952123a1c962d41413bb6979a0ee31cf30028b25ef3e3b8bcd5849fc`; the artwork dimensions are `StoreLogo` 256x256, `Square150x150Logo` 150x150, `Square44x44Logo` 44x44, and `SplashScreen` 620x300. The package verifier passed; publisher certificate trust and target deployment remain open.
