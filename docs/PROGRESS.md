...
- `scripts/Test-MementoMsix.ps1` now validates the package identity/version, expected MEMENTO application entry, visual asset references, and exact asset names before accepting the MSIX payload gate; the latest unsigned package passed this stricter check.
