...
- MSIX artwork is now checked in under `packaging/assets` and copied by `Build-MementoMsix.ps1`; the rebuilt unsigned package passed `Test-MementoMsix.ps1` at **108,730,111 bytes**, SHA-256 `0c7fa1b31b27caf4c999e03b86897a80c8b22363cc0f4ba532021d2f30582aff`. The four PNGs are 256x256, 150x150, 44x44, and 620x300 respectively; this removes generated 1x1 placeholders without claiming publisher trust or installability.
