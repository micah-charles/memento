...
- The latest published bundle (106,521,580 bytes; SHA-256 `aabf81ec62a88eac60c0bcecb63482e63b79165b5b4c882ecda571cdba600031`) was installed with `scripts\\Install-Memento.ps1`; its checksum preflight passed, the per-user executable and Start Menu shortcut were refreshed, and the installed app tree now contains the scoped redacted-export shell. Native GUI and microphone gates remain supervised.
...
- MSIX artwork is now checked in under `packaging/assets` and copied by `Build-MementoMsix.ps1`; the rebuilt unsigned package passed `Test-MementoMsix.ps1` at **108,730,462 bytes**, SHA-256 `8bfd5f07b067a811196938991c127f58909d739554418c10dba97587bfd5aae4`. The four PNGs are 256x256, 150x150, 44x44, and 620x300 respectively; this removes generated 1x1 placeholders without claiming publisher trust or installability.
