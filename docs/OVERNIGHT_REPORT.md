...
- Published bundle — `artifacts/MEMENTO-win-x64.zip`, 106,528,234 bytes, SHA-256 `1fe6fe3a0adf9f931f981358a200f56d88779a9b5fcc25753a9d30fb02b9ed39`.
...
- MSIX artwork replacement — `Build-MementoMsix.ps1` now copies checked-in deterministic MEMENTO artwork from `packaging/assets` instead of generating 1x1 placeholders. The latest unsigned package is 108,736,784 bytes with SHA-256 `53ee2ad6cb47b49684a9cefcf0bc1448316322b7da3a493fd2cc76739c86e443`; all four artwork dimensions were inspected and `Test-MementoMsix.ps1` passed. Publisher trust and target deployment remain open.
