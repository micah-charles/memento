...
- Published bundle — `artifacts/MEMENTO-win-x64.zip`, 106,527,741 bytes, SHA-256 `b9d3b698e68675059d8d91b6d6b911e0ab2395ca44b4333c1795dbba17235950`.
...
- MSIX artwork replacement — `Build-MementoMsix.ps1` now copies checked-in deterministic MEMENTO artwork from `packaging/assets` instead of generating 1x1 placeholders. The latest unsigned package is 108,736,261 bytes with SHA-256 `41aa61c403d2c6fd81b57c7a2bcdd2ef27a36ee96638c4a8814c0a6b26ccbd45`; all four artwork dimensions were inspected and `Test-MementoMsix.ps1` passed. Publisher trust and target deployment remain open.
