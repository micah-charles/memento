...
- Published bundle — `artifacts/MEMENTO-win-x64.zip`, 106,520,922 bytes, SHA-256 `931e3f87a611bfbdf08ede21095f24d1cac9a45baf19cd115b258c42a5061c7b`.
...
- MSIX artwork replacement — `Build-MementoMsix.ps1` now copies checked-in deterministic MEMENTO artwork from `packaging/assets` instead of generating 1x1 placeholders. The latest unsigned package is 108,729,805 bytes with SHA-256 `fd78d6f26da5925fd6b0d3c9620455cfb8446b2dcfd6f7f0608bf4e8211512f5`; all four artwork dimensions were inspected and `Test-MementoMsix.ps1` passed. Publisher trust and target deployment remain open.
