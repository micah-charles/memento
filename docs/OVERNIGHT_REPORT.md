...
**Current local checkpoint:** `35a8581` (`feat: persist and expose realtime speech output`).
...
- Published bundle — `artifacts/MEMENTO-win-x64.zip`, 109,599,499 bytes, SHA-256 `66fe5d99832562ba0583e7a2052261004fa220625340923e4e2c6301facec6a6`.
