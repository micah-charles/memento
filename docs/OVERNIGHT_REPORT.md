...
- Published bundle — `artifacts/MEMENTO-win-x64.zip`, 106,521,194 bytes, SHA-256 `7741afcb02a02e97f5722ba81c504da5b8f6d79ff952c18161fd94926ddc6d41`.
...
- MSIX artwork replacement — `Build-MementoMsix.ps1` now copies checked-in deterministic MEMENTO artwork from `packaging/assets` instead of generating 1x1 placeholders. The latest unsigned package is 108,730,111 bytes with SHA-256 `0c7fa1b31b27caf4c999e03b86897a80c8b22363cc0f4ba532021d2f30582aff`; all four artwork dimensions were inspected and `Test-MementoMsix.ps1` passed. Publisher trust and target deployment remain open.
