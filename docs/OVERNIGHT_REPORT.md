...
- `Verify-MementoAutomation.ps1 -VerifyMsix` now delegates to the MSIX verifier; its unsigned inspection passed, while the negative `-RequireMsixSignature` run rejected the unsigned package as expected.
