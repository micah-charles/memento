...
- Published bundle — `artifacts/MEMENTO-win-x64.zip`, 106,525,444 bytes, SHA-256 `69523f87cdcd5a14a92ffa2b933c5a1c258106c921599d677e559f802a116f23`.
...
- MSIX artwork replacement — `Build-MementoMsix.ps1` now copies checked-in deterministic MEMENTO artwork from `packaging/assets` instead of generating 1x1 placeholders. The latest unsigned package is 108,734,221 bytes with SHA-256 `09a3982f2447a4c65a14db496029e2a45b0a1d75fd6c3640da08da74d116aac4`; all four artwork dimensions were inspected and `Test-MementoMsix.ps1` passed. Publisher trust and target deployment remain open.
