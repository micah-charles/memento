...
- `dotnet test tests\\Memento.Core.Tests\\Memento.Core.Tests.csproj --configuration Release --no-restore` — **143 passed, 0 failed**.
...
- Published bundle — `artifacts/MEMENTO-win-x64.zip`, 106,493,943 bytes, SHA-256 `57c48617621e08a0091252bcbc0a14cd56cfd66ddcbd1ebda4ee93cc85fa74a5`.
