...
- Published bundle — `artifacts/MEMENTO-win-x64.zip`, 106,522,537 bytes, SHA-256 `5062e041c7ffe123d3faaada2effd7c646fda1a1889c6f235df87b5b85d3c023`.
...
- MSIX artwork replacement — `Build-MementoMsix.ps1` now copies checked-in deterministic MEMENTO artwork from `packaging/assets` instead of generating 1x1 placeholders. The latest unsigned package is 108,731,412 bytes with SHA-256 `0a8a2e48e5bc2c8967c68e54e35dca9f600274930afe107901192aaebe508b87`; all four artwork dimensions were inspected and `Test-MementoMsix.ps1` passed. Publisher trust and target deployment remain open.
